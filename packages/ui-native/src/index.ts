...
/**
 * `Text` and `TextInput` in the theme's face. Exported because React Native has no cascade,
 * so a font given to the provider does not reach a `Text` written by hand.
 */
