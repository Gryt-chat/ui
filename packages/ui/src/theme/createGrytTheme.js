import { alphaScale, hueScale, hueScaleLight, neutralScale, neutralScaleLight } from "./oklch";
...
export const grytScales = {
    ...
    secondary: hueScale(grytTokens.color.secondary, grytTokens.color.secondaryLight),
...
export function createGrytTheme(options = {}) {
    ...
    for (const name of ["neutral", "accent"]) {
