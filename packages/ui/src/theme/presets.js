...
const ROUND = { sm: 8, md: 12, lg: 20, xl: 28, full: 999 };
const SOFT = { sm: 6, md: 8, lg: 14, xl: 18, full: 999 };
/** Buttons that are not pills. `full` is what controls use, so it does the work. */
const CRISP = { sm: 4, md: 6, lg: 10, xl: 14, full: 6 };
const SHADCN = { sm: 6, md: 8, lg: 10, xl: 14, full: 10 };
const SQUARE = { sm: 2, md: 4, lg: 6, xl: 8, full: 4 };
export const grytPresets = [
    {
        id: "gryt",
        name: "Gryt",
...
export const grytPresetsById = new Map(grytPresets.map((preset) => [preset.id, preset]));
