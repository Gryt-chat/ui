...
// The ./theme subpath has its own declaration for the same reason the root does: the
// require condition points at a .d.cts and vite-plugin-dts only emits .d.ts (GRYT-351).
